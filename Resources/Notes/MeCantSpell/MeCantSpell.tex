...
\label{sec:org2acf452}
Earlier in \ref{sec:org06949b8} we looked at files like .html, .css and .js that we
...
\label{sec:org459d6ae}
\subsection{HTML Syntax}
\label{sec:org78e2a83}
...
\end{enumerate}
\section{CSS}
\label{sec:org5dbc0dc}

\subsection{CSS Syntax}
\label{sec:org49f0c8b}
\begin{enumerate}
...
\end{verbatim}
This can be easily rememebered using the mnemonic "\textbf{LoVe Hates FeAr}"
\end{enumerate}
\end{document}
