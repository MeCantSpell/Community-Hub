...
\label{sec:org2d1449a}
Earlier in \ref{sec:org6ee0627} we looked at files like .html, .css and .js that we
...
\label{sec:org1a11251}
\subsection{HTML Syntax}
\label{sec:orgd2ea309}
...
\end{enumerate}
\section{CSS}
\label{sec:orge5eb042}

\subsection{CSS Syntax}
\label{sec:org71492a6}
\begin{enumerate}
